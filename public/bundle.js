...
exports.receiveCloset = receiveCloset;
exports.fetchCloset = fetchCloset;
...
function fetchCloset() {
    return function (dispatch) {
        _superagent2.default.get('/api/v1/closet').then(function (res) {
            return res.body;
...
var _Closet = __webpack_require__(/*! ./Closet */ "./client/components/Closet.jsx");
...
var Closet = function (_React$Component) {
    ...
    function Closet(props) {
        ...
        return _possibleConstructorReturn(this, (Closet.__proto__ || Object.getPrototypeOf(Closet)).call(this, props));
    }

    _createClass(Closet, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.props.dispatch((0, _actions.fetchCloset)());
        }
    }, {
        key: 'render',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'ul',
                        null,
                        this.props.closet.length > 0 && this.props.closet.map(function (colour) {
                            return _react2.default.createElement(
                                'li',
                                { key: closet.id },
                                closet.closet
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(Closet);
...
var Footer = function Footer() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "p",
            { className: "description col-lg-12" },
            "The personal closet allows you to have an easy scroll around your closet. It gives you the sensation of online buying without the consumtion. Rediscover your own gems. Be happy with what you have."
        )
    );
};
...
var _closet = __webpack_require__(/*! ./closet */ "./client/reducers/closet.js");
