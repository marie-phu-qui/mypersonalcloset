...
exports.receiveData = exports.showError = exports.requestDATA = undefined;
exports.fetchClothes = fetchClothes;
...
function fetchClothes() {
  ...
  return function (dispatch) {
    ...
    return _superagent2.default.get('/').then(function (res) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    dispatch((0, _actions.fetchClothes)());
    return {};
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ItemsList);
